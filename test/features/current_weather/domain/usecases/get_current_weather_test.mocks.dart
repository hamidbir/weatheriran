...
// in weatheriran/test/features/current_weather/domain/usecases/get_current_weather_test.dart.
...
import 'package:weatheriran/core/error/failure.dart' as _i5;
...
class MockWeatherRepository extends _i1.Mock implements _i3.WeatherRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, _i6.CurrentWeather>> getCurrentWeather() =>
      (super.noSuchMethod(
        Invocation.method(
          #getCurrentWeather,
          [],
